...
//search for mobile phones
        ...
        searchInput.submit();
//filter products
        WebElement brand = driver.findElement(By.xpath("//div[@title='SAMSUNG']"));
        brand.click();
        Thread.sleep(5000);
        WebElement rating = driver.findElement(By.xpath("//div[@title='4★ & above']"));
        rating.click();
        Thread.sleep(5000);
        WebElement RAM = driver.findElement(By.xpath("//div[@title='6 GB']"));
        RAM.click();
        Thread.sleep(5000);
...
//add numphone mobile phoes to cart
        ...
        int numphone = 3;
        for (int i = 0; i < numphone * 2 && i < mobileElements.size(); i = i + 2) {
